...
app.get ('/saveLog', function (req, res) {
	...
	shelljs.exec('saveLog.exe ' + name, function(code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
...
app.get ('/readName', function (req, res) {

	var filename = req.query.filename;
	console.log ('file: ' + filename);

	shelljs.exec ('readName.exe ' + filename, function (code, stdout, stderr) {
	  console.log('Exit status:'+ code);
	  console.log('Exit output:'+ stdout);
